		...
		<>
			<MaterialReactTable
				...
				renderTopToolbarCustomActions={() => (
					<Box>
						...
						<Button variant="contained">Xuất dụng cụ</Button>
					</Box>
				)}
			...
			>
				<DialogTitle textAlign="center">
					<b>Sửa thông tin nhóm nghiên cứu</b>
				</DialogTitle>
				<DialogContent>
			...
			<Dialog open={isDeleteModal}>
				<DialogTitle textAlign="center">
					<b>Xoá thông tin nhóm nghiên cứu</b>
				</DialogTitle>
				<DialogContent>
			...
			>
				<DialogTitle textAlign="center">
					<b>Tạo thông tin nhóm nghiên cứu</b>
				</DialogTitle>
				<DialogContent>
					<form onSubmit={e => e.preventDefault()} style={{ marginTop: '10px' }}>
						<Stack
								...
								if (column.accessorKey === 'Note') {
									return (
										<TextareaAutosize
											...
											onChange={e => setCreatedRow({ ...createdRow, Note: e.target.value })}
										/>
									);
								} else {
									return (
