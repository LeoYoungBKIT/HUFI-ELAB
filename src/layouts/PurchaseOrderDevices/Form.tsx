        ...
        >
            ...
            <Box sx={{ ...style }}>
                {formsControlDeviceServiceInfo.map((x) => {
                    ...
                    if (sourceKey === "EmployeeCreateId")
                        return (
                            <TextField
                                value={
                                    value + " - " + data["EmployeeCreateName"]
                                }
                                key={sourceKey}
                                label={label}
                                variant="outlined"
                    ...
                    if (sourceKey === "DepartmentImportId")
                        return (
                            <TextField
                                value={
                                    value + " - " + data.DepartmentImportName
                                }
                                key={sourceKey}
                                label={label}
                                variant="outlined"
            ...
            <Box sx={{ my: 2, gap: 2, display: "flex", justifyContent: "end" }}>
                ...
                <AlertDialog
                    ...
                    handleOk={(text) => {
                        if (handleOnclickNoAccept)
                            handleOnclickNoAccept(data, text || "");
                    }}
                    showBoxInput
                    boxInputProps={{
                        label: "nội dung",
                ...
                {enableAcceptButton &&
                    matchAccept(GroupName, data.Status || "") && (
                        <Button
                            variant="contained"
...
const style: SxProps = {
    ...
    "& .MuiFormControl-root ": { m: 1, minWidth: "400px" },
};
