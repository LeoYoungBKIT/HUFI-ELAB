...
const DataGridFunc = React.memo(function DataGridFunc({
    ...
    const editCellLinkFileRepairRender = useEvent(
    ...
    const editCellLinkFileMaintenace = useEvent(
        (cellInfo: ColumnEditCellTemplateData) => (
            <FileUploaderEditor
                cellInfo={cellInfo}
                retryButtonVisible={retryButtonVisible}
                ...
                <Form>
                    <Item itemType="group" colCount={2} colSpan={2}>
                        {commonFieldsShow.map((ele) => {
                            if (
                                ele.id !== "LinkFileRepair" &&
                                ele.id !== "LinkFileMaintenace"
                            ) {
                    ...
                    <Item
                        itemType="group"
                        caption="Biên bản kiểm tra thiết bị từ Đơn vị phụ trách tiếp nhận sửa chữa"
                        colCount={2}
                        colSpan={2}
                    >
                    ...
                    <Item
                        itemType="group"
                        caption="Lịch sử bảo trì/sửa chữa"
                        colCount={2}
                        colSpan={2}
                    >
