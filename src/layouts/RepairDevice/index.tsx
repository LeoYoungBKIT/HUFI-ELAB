...
const RepairDevice = () => {
    ...
    const departments = useAppSelector(
        (state) => state.department.listOfDepartments
    );
    ...
    const getDeviceInfo = async () => {
        const department = departments.find(
            (d) => d?.DepartmentName === owner.DepartmentName
        );

        if (department) {
            const devicesInfo = await getDeviceGeneralDept(
    ...
    const dataGridFromRef = useRef<DataGrid<IRepairDevice, string> | null>(
        null
    );
        ...
        >
            ...
            >
                <DataGrid
                    ...
                    elementAttr={{
                        style: "height: 100%; padding: 10px 0; width: 100%;min-width: 600px",
                    }}
                ...
                >
                    ...
                    <Column type="buttons" width={60} fixed={true}>
                        <DevButtonGrid
                            icon="chevrondown"
                            onClick={(
                                e: ColumnCellTemplateData<IRepairDevice, string>
                            ) => {
                    ...
                    <Toolbar>
                        ...
                        {[ADMIN, UNIT_UTILIZATION_SPECIALIST].includes(
                            owner.GroupName
                        ) && (
                            <Item location="after">
                                <Button
